    ...
    <div class=" headerOptionsBase">
        <div class="container">
            <div class="w3-bar w3-center headerOptions " style="width:100%; overflow:hidden;height:44px">
                <a class="w3-bar-item w3-button" href="paciente.php" title="">Início</a>
                <a class="w3-bar-item w3-button" href="#" title="">Requisitar Exames</a>
                <a class="w3-bar-item w3-button" href="#" title="">Ver Resultados</a>
